...
namespace ProtoBuf
{
    ...
    public sealed class ProtoReader : IDisposable
    {
        ...
        public string ReadString()
        {
            if (wireType == WireType.String)
            {
                ...
                string s = /*encoding.GetString*/Encoding.UTF8.GetString(ioBuffer, ioIndex, bytes);
 ...
 double ReadDouble()
        ...
        public int ReadFieldHeader()
        {
            ...
            {
                //Debug.WriteLine("The tag is: " + tag+", the available is: "+ available+", the ioIndex is: "+ioIndex);
                if(available == 971)
                {
                    Debug.WriteLine("we are in");
                }
                int ored = (int)(tag & 7);
                WireType testType = WireType.None;
                switch (ored)
                {
                    case -1:
                        testType = WireType.None;
                        break;
                    case 0:
                        testType = WireType.Variant;
                        break;
                    case 1:
                        testType = WireType.Fixed64;
                        break;
                    case 2:
                        testType = WireType.String;
                        break;
                    case 3:
                        testType = WireType.StartGroup;
                        break;
                    case 4:
                        testType = WireType.EndGroup;
                        break;
                    case 5:
                        testType = WireType.Fixed32;
                        break;
                    case 0 | (1 << 3):
                        testType = WireType.SignedVariant;
                        break;
                }
                wireType = testType;
