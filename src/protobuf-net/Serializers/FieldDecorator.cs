...
namespace ProtoBuf.Serializers
{
    sealed class FieldDecorator : ProtoDecoratorBase
    {
        ...
        public override void Write(object value, ProtoWriter dest)
        {
            ...
            if (value != null && value == typeof(object)) Tail.Write(value, dest);
        }

        public override object Read(object value, ProtoReader source)
        {
            Helpers.DebugAssert(value != null);
            bool requiredOldValue = Tail.RequiresOldValue;
            object resultingValue = null;
            if (requiredOldValue)
            {
                resultingValue = field.GetValue(value);
            }
            object newValue = Tail.Read(resultingValue, source);
