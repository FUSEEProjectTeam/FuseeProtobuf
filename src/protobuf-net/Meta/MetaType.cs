...
namespace ProtoBuf.Meta
{
    ...
    public class MetaType : ISerializerProxy
    {
        ...
        internal static ConstructorInfo ResolveTupleConstructor(Type type, out MemberInfo[] mappedMembers)
        {
            ...
            bool demandReadOnly = type.Name.Contains("Tuple");
            ...
            for (int i = 0; i < ctors.Length; i++)
            {
                ...
                for (int j = 0; j < parameters.Length; j++)
                {
                    ...
                    {
                        if (string.Compare(parameters[j].Name.ToLower(), members[k].Name.ToLower()) != 0) continue;
        ...
        {
            if(memberName == "AsReferenceHasValue")
            {
                //Debug.WriteLine("Hello its AsReferenceHasValue");
            }
